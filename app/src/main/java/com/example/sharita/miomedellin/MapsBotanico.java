...
public class MapsBotanico extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng botanico = new LatLng(6.2708978, -75.5633316);
        ...
        setmMarker(botanico,"Jardín Botánico","Sitio Turístico");
        mcam= CameraUpdateFactory.newLatLngZoom(botanico,17);
        mMap.animateCamera(mcam);
